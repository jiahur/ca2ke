...
<body>
    ...
    <div id="nav">
		<ul>
			<a href="#"><span class="nav01">
		    	<img src="img/go_left.png" alt="cake" style="width: 60px; height: 90px;"/>
		    </span></a>
		    
		    
		    
		    
		    <li><a href="#"><span class="nav01">
		    	<img src="img/cake.png" alt="cake" style="width: 60px; height: 90px;"/>
		    	<br/>CAKE
		    </span></a></li>
		    <li><a href="#"><span class="nav03">
		    	<img src="img/macaron.png" alt="macaron" style="width: 60px; height: 90px;"/>
		    	<br/>MACARON
		    </span></a></li>
		    <li><a href="#"><span class="nav02">
		    ...
		    <a href="#"><span class="nav01">
		    	<img src="img/go_right.png" alt="cake" style="width: 60px; height: 90px;"/>
		    </span></a>
		</ul>
    </div>
