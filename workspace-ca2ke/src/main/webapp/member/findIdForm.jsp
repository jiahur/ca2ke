		...
		<div class="sub-contents-box">
       	<ul class="tab-list-box column2">
			...
			<div class="tab-contents">
            	...
            	본인 명의의 이메일으로 <span class="t-gray">본인 인증을 통해,</span><br /><span class="t-gray">아이디를 확인</span>하실 수 있습니다.
                    </p>
                    <i class="icon-cer-phone"></i>
                    <div class="icon-btn-box">
                    	<a href="#" onclick="idFind()" class="btn xl font-l black pd-xl">이메일 인증하기</a>
                	</div>
            	</div>
			</div>
		</div>
